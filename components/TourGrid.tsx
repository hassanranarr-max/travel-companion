    ...
    <div className="py-24 bg-white">
      ...
      <section id="umrah" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-28">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16">
          ...
          <button className="mt-8 md:mt-0 flex items-center px-8 py-4 bg-[#0F0F0F] text-white rounded-2xl font-bold hover:bg-orange-500 transition-all group">
      ...
      <section id="domestic" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16">
          ...
          <button className="mt-8 md:mt-0 flex items-center px-8 py-4 bg-white border border-slate-200 text-[#0F0F0F] rounded-2xl font-bold hover:border-orange-500 hover:text-orange-500 transition-all group">
